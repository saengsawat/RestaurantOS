...
| **E11-T3** split POS UI | Pay-modal split flow + per-portion receipts, tokens per DESIGN.md. Contract: `docs/tickets/E11-T3-split-pos-ui.md` | **Ready** (T2 merged) · Sonnet or Codex (D17) |
