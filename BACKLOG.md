...
| **E11-T2** split engine/API | Split preview reads + labeled portion payments on the server. Contract: `docs/tickets/E11-T2-split-engine-api.md` (now carries T1's empty-seat handoff note). Not concurrent with E19-T1 | **Ready** · Opus, cross-model review |
...
Suite total: 99 tests green (70 domain + 29 server incl. PostgreSQL integration).
