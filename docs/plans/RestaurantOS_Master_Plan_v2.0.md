...
| **E6** | Floor plan / tables | 🔄 In progress (core done; editor-full approved 2026-08-25, D26: add/edit/resize/retire tables and areas) | Areas, tables, parties, guest counts | E4 | Table status derived from domain state, not UI **[T]** | Two-terminal table-state consistency test | Sonnet |
...
**Status as of 2026-08-25** (13 completed, 4 in progress, 5 in queue; E6 reopened for the full editor and E21/E22 added per D26). Where the non-clean rows stand:
