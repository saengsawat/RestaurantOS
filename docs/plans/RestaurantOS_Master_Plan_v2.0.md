...
- **E19 insights**: T1 (server attribution + the two read APIs, conservation-tested against the day summary) merged 2026-08-23. T2, the /insights page consuming those endpoints, is the remainder.
