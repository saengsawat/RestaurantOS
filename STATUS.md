...
Phase 4  Build            █████████░  16 epics done (E5 menu closed), E17/E22/E24 in progress: lock screen + seven screens + PostgreSQL, any restaurant can set itself up, and now import its menu from a spreadsheet (208 tests)
