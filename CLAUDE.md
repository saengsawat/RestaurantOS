...
- **Never use em dashes (—)** in any content: docs, UI copy, commit messages, code comments, chat replies. Andy finds them robotic. Use a comma, colon, period, or parentheses instead. (En dashes in numeric ranges like 6–12 are fine.)
